...
import Background from '../../assets/Sidebar-lotomania.svg'
...
export const SidebarLotoM = () => {
    ...
    const getInitialData = () => {
      axios
        ...
        .then((res) => {
          setInitialDraws(res.data[3])
          
          if (initialDraws) {
            setDrawsID(res.data[3].concursoId)
          }
        })
        .catch((error) => {
