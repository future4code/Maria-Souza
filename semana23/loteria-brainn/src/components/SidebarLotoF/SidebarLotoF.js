...
import Background from '../../assets/Sidebar-lotofacil.svg'
...
export const SidebarLotoF = () => {
    ...
    const getInitialData = () => {
      axios
        ...
        .then((res) => {
          setInitialDraws(res.data[2])
          
          if (initialDraws) {
            setDrawsID(res.data[2].concursoId)
          }
        })
        .catch((error) => {
