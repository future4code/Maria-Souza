...
import Background from '../../assets/Sidebar-timemania.svg'
...
export const SidebarDiaS = () => {
    ...
    const getInitialData = () => {
      axios
        ...
        .then((res) => {
          setInitialDraws(res.data[4])
          
          if (initialDraws) {
            setDrawsID(res.data[4].concursoId)
          }
        })
        .catch((error) => {
