...
import Background from '../../assets/Sidebar-diadesorte.svg'
...
export const SidebarTimeM = () => {
    ...
    const getInitialData = () => {
      axios
        ...
        .then((res) => {
          setInitialDraws(res.data[5])
          
          if (initialDraws) {
            setDrawsID(res.data[5].concursoId)
          }
        })
        .catch((error) => {
